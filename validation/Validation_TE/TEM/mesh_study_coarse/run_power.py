...
for (i, current) in enumerate(I):
  ...
  #  command_list = ['ls', '-l', '> out']
   command_list = ['mpirun', '-n', '20','moose-dev-exec', '/projects/USU/Thermoelectric-Working/tetra_bitterroot/tetra/tetra-opt', '-i', 'module_cuboid_pattern_sq.i',
                        f'I={current}', f'Outputs/file_base={base}', '-w']
  #  print(command_list)
